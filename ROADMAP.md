...
- **Tests**: 105 tests across 12 files, all green
- **Lint / Format**: clean
...
| `feature/template-marketplace` | P3b  | ✅ Done             |
...
| 2026-07-30 | P3b (template marketplace) done in `feature/template-marketplace` — 5 MVP templates, gallery modal, replace/append insertion, tests |
